...
export class POPULATEDATABASE1575583932508 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`
                        INSERT INTO hero 
                            (id, name, price, sprites)
                        VALUES
                            (1, 'Warrior', 0, '{"Idle":17}'),
                            (2, 'Mage', 100, '{"Idle":17}'),
                            (3, 'Ninja', 200, '{"Idle":17}'),
                            (4, 'Pirate', 300, '{"Idle":17}'),
                            (5, 'Monk', 400, '{"Idle":17}'),
                            (6, 'Paladin', 500, '{"Idle":17}'),
                            (7, 'King', 600, '{"Idle":17}');
                    `);
    ...
    await queryRunner.query(`
                        INSERT INTO hero_capacities_capacity
                            (hero_id, capacity_id)
                        VALUES
                            (1, 1),
                            (2, 2),
