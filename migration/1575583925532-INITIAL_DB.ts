...
export class INITIALDB1575583925532 implements MigrationInterface {
    name = 'INITIALDB1575583925532'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `hero` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(25) NOT NULL, `price` int NOT NULL, `sprites` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(25) NOT NULL, `nickname` varchar(25) NOT NULL, `password` varchar(255) NOT NULL, `gold` int NOT NULL DEFAULT 0, `inventory` varchar(255) NOT NULL DEFAULT '{\"heroes\":[1]}', `games_played` int NOT NULL DEFAULT 0, `highscore` int NOT NULL DEFAULT 0, `clubId` int NULL, `heroId` int NULL, UNIQUE INDEX `IDX_e2364281027b926b879fa2fa1e` (`nickname`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
