...
export class INITIALDB1575494016666 implements MigrationInterface {
    name = 'INITIALDB1575494016666'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `hero_capacities_capacity` (`heroId` int NOT NULL, `capacityId` int NOT NULL, INDEX `IDX_4df81b638bb4423279b7ce4150` (`heroId`), INDEX `IDX_b0f43e1071d80a1f33af8c6e8f` (`capacityId`), PRIMARY KEY (`heroId`, `capacityId`)) ENGINE=InnoDB", undefined);
        ...
        await queryRunner.query("ALTER TABLE `hero_capacities_capacity` ADD CONSTRAINT `FK_4df81b638bb4423279b7ce4150e` FOREIGN KEY (`heroId`) REFERENCES `hero`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `hero_capacities_capacity` ADD CONSTRAINT `FK_b0f43e1071d80a1f33af8c6e8f7` FOREIGN KEY (`capacityId`) REFERENCES `capacity`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `hero_capacities_capacity` DROP FOREIGN KEY `FK_b0f43e1071d80a1f33af8c6e8f7`", undefined);
        await queryRunner.query("ALTER TABLE `hero_capacities_capacity` DROP FOREIGN KEY `FK_4df81b638bb4423279b7ce4150e`", undefined);
        ...
        await queryRunner.query("DROP INDEX `IDX_b0f43e1071d80a1f33af8c6e8f` ON `hero_capacities_capacity`", undefined);
        await queryRunner.query("DROP INDEX `IDX_4df81b638bb4423279b7ce4150` ON `hero_capacities_capacity`", undefined);
